...
"builtin.module"() ({
  "func.func"() <{function_type = (!cir.int<s, 32>, !cir.bool, !cir.ptr<!cir.int<s, 32>>) -> !cir.int<u, 8>, sym_name = "types"}> ({
  ^bb0(%a : !cir.int<s, 32>, %b : !cir.bool, %p : !cir.ptr<!cir.int<s, 32>>):
    ...
    "test.test"(%p) {fn_ptr = !cir.ptr<!cir.func<()>>, ptr_ptr = !cir.ptr<!cir.ptr<!cir.bool>>} : (!cir.ptr<!cir.int<s, 32>>) -> ()
    "func.return"(%0) : (!cir.int<u, 8>) -> ()
  }) : () -> ()
}) : () -> ()

// CHECK:      "func.func"() <{"function_type" = (!cir.int<s, 32>, !cir.bool, !cir.ptr<!cir.int<s, 32>>) -> !cir.int<u, 8>, "sym_name" = "types"}> ({
// CHECK-NEXT:   ^{{.*}}([[A:%.*]] : !cir.int<s, 32>, [[B:%.*]] : !cir.bool, [[P:%.*]] : !cir.ptr<!cir.int<s, 32>>):
...
// CHECK-NEXT:     "test.test"([[P]]) {"fn_ptr" = !cir.ptr<!cir.func<()>>, "ptr_ptr" = !cir.ptr<!cir.ptr<!cir.bool>>} : (!cir.ptr<!cir.int<s, 32>>) -> ()
